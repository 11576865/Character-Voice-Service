const CACHE = "cvs-reader-shell-v5";
const SHELL = ["/", "/reader-assets/reader.css?v=4", "/reader-assets/favicon.svg?v=3",
  "/reader-assets/js/reader.js?v=5", "/reader-assets/js/sources.js",
