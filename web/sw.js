const CACHE = "cvs-reader-shell-v10";
const SHELL = ["/", "/reader-assets/reader.css?v=7", "/reader-assets/favicon.svg?v=3",
  "/reader-assets/js/reader.js?v=10", "/reader-assets/js/sources.js",
